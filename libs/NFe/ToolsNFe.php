...
class ToolsNFe extends BaseTools
{
    ...
    public function enviaMail($pathXml = '', $aMails = array(), $templateFile = '', $comPdf = false, $pathPdf = '')
    {
        ...
        if (!$mail->envia($pathXml, $aMails, $comPdf, $pathPdf) === false) {
            echo ('Email não enviado. '.$mail->error);
        }
        return true;
    }
    ...
    /**
     * addCancelamento
     * Adiciona a tag de cancelamento a uma NFe já autorizada
    ...
    public function sefazDistDFe(
        /*
         * NT 2014.002
         * @see https://groups.google.com/forum/#!topic/nfephp/a7JTgfNvqJk
         * 
         * $fonte = 'AN',
         * $tpAmb = '2',
         * $cnpj = '',
    ...
    public function validarXml($xml = '')
    {
        ...
        //echo $this->aConfig['schemesNFe'] . DIRECTORY_SEPARATOR . $xsdFile;
