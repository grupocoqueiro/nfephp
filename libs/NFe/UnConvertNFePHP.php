...
class UnConvertNFePHP
{
    ...
    private function cxtt($dom)
    {
        ...
        $dEmi = !empty($ide->getElementsByTagName('dEmi')->item(0)->nodeValue) ? $ide->getElementsByTagName('dEmi')->item(0)->nodeValue : $ide->getElementsByTagName('dhEmi')->item(0)->nodeValue;
        $dSaiEnt = !empty($ide->getElementsByTagName('dSaiEnt')->item(0)->nodeValue) ?
                $ide->getElementsByTagName('dSaiEnt')->item(0)->nodeValue : $ide->getElementsByTagName('dhSaiEnt')->item(0)->nodeValue;
        ...
        $dhCont = !empty($ide->getElementsByTagName('dhCont')->item(0)->nodeValue) ? $ide->getElementsByTagName('dhCont')->item(0)->nodeValue : '';
        $xJust = !empty($ide->getElementsByTagName('xJust')->item(0)->nodeValue) ? $ide->getElementsByTagName('xJust')->item(0)->nodeValue : '';
        ...
        if ($vTotTrib == '') {
            ...
            //W02|vBC|vICMS|vBCST|vST|vProd|vFrete|vSeg|vDesc|vII|vIPI|vPIS|vCOFINS|vOutro|vNF|
            $txt .= "W02|$vBC|$vICMS|$vBCST|$vST|$vProd|$vFrete|$vSeg|$vDesc|$vII|$vIPI|$vPIS|$vCOFINS|$vOutro|$vNF|$vTotTrib|\r\n";
        }
    ...
    private function getItens($det)
    {
        ...
        foreach ($det as $d) {
            ...
            if (isset($veicProd)) {
                ...
                $txt .= "J|$tpOp|$chassi|$cCor|$xCor|$pot|$cilin|$pesoL|$pesoB|$nSerie|$tpComb|$nMotor|$CMT|$dist|$anoMod|$anoFab|$tpPint|$tpVeic|$espVeic|$vIN|$condVeic|$cMod|$cCorDENATRAN|$lote|$tpRest|\r\n";
            } // fim veiculos novos
            ...
            switch ($CST) {
                ...
                case '90': //CST - 90 Outros
                    ...
                    $txt .= "N10|$orig|$CST|$modBC|$pRedBC|$vBC|$pICMS|$vICMS|$modBCST|$pMVAST|$pRedBCST|$vBCST|$pICMSST|$vICMSST|\r\n";
                    break;
            ...
            switch ($CSOSN) {
                ...
                case '201': // CSON - 201
                    ...
                    $txt .= "N10e|$orig|$CSOSN|$modBCST|$pMVAST|$pRedBCST|$vBCST|$pICMSS|$vICMSST|$pCredSN|$vCredICMSSN|\r\n";
                    break;
                ...
                case '203': // CSOSN=202 ou 203 [ICMS]
                    ...
                    $txt .= "N10f|$orig|$CSOSN|$modBCST|$pMVAST|$pRedBCST|$vBCST|$pICMSST|$vICMSST|\r\n";
                    break;
                case '500': // CSON - 500
                ...
                case '900': // CSON - 900
                    ...
                    $txt .= "N10h|$orig|$CSOSN|$modBC|$vBC|$pRedBC|$pICMS|$vICMS|$modBCST|$pMVAST|$pRedBCST|$vBCST|$pICMSST|$vICMSST|$pCredSN|$vCredICMSSN|\r\n";
                    break;
            } // fim switch
