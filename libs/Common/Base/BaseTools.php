...
class BaseTools
{
    ...
    /**
     * Carrega as configurações de proxy
     */
    protected function zProxySoapClass()
    {
        if(!($this->oSoap instanceof CurlSoap)){
            $this->zLoadSoapClass();
        }
        
        $this->oSoap->setProxy($this->aConfig['aProxyConf']->proxyIp, $this->aConfig['aProxyConf']->proxyPort);
    }
